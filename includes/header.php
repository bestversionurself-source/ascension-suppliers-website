...
<a class="<?= $page==='home'?'active':'' ?>" href="/">Home</a><a class="<?= $page==='services'?'active':'' ?>" href="/services.php">Services</a><a class="<?= $page==='packages'?'active':'' ?>" href="/packages.php">Packages</a><a class="<?= $page==='contact'?'active':'' ?>" href="/contact.php">Contact</a><a href="/packages.php">Subscribe</a><a class="cta" href="/packages.php">Build my website ↗</a>
</nav></div></header>
