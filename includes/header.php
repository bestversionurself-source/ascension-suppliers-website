...
<header><div class="wrap nav"><a class="brand header-brand" href="/" aria-label="Ascension Suppliers home"><img class="brand-logo" src="/assets/images/ascension-logo.jpg" alt="Ascension Suppliers — Design. Develop. Deliver."></a><button class="menu" aria-label="Open menu">☰</button><nav>
